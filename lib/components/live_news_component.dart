...
class LiveNewsComponent extends StatefulWidget {
  final String videoUrl; // Parameter to accept the video URL

  const LiveNewsComponent({Key? key, required this.videoUrl}) : super(key: key);

  @override
  _VideoComponentState createState() => _VideoComponentState();
}

class _VideoComponentState extends State<LiveNewsComponent> {
